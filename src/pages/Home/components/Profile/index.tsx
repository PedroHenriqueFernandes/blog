...
export function Profile() {
  ...
  useEffect(() => {
    axios
      .get('https://api.github.com/users/PedroHenriqueFernandes')
      .then((response) => {
